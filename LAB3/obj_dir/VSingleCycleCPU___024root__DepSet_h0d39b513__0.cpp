...
void VSingleCycleCPU___024root___eval_triggers__act(VSingleCycleCPU___024root* vlSelf) {
    ...
    vlSelf->__VactTriggered.at(2U) = (((IData)(vlSelf->clk) 
                                      ...
                                      | ((~ (IData)(vlSelf->start)) 
                                         & (IData)(vlSelf->__Vtrigrprev__TOP__start)));
    vlSelf->__VactTriggered.at(3U) = ((vlSelf->SingleCycleCPU__DOT__EX_MEM_ALU_result_w 
                                       != vlSelf->__Vtrigrprev__TOP__SingleCycleCPU__DOT__EX_MEM_ALU_result_w) 
                                      | ((IData)(vlSelf->SingleCycleCPU__DOT__EX_MEM_memRead_w) 
                                         != (IData)(vlSelf->__Vtrigrprev__TOP__SingleCycleCPU__DOT__EX_MEM_memRead_w)));
